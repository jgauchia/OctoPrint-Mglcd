			...
			if self.currentPage == 'home':
				...
				try:
					...
					if printTime > 59:	
						...
						printTimeString = '"{:02d}:{:02d}:{:02d}"'.format(int(math.floor(printTime/3600)),int(math.floor(printTime/60)),int(math.fmod(printTime,60)))
					else:
				                printTimeString = '"00:00:{:02d}"'.format(printTime)
